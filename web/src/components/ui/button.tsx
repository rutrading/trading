...
export const buttonVariants = tv({
  ...
  variants: {
      ...
      variant: {
        ...
        warning:
          "bg-[linear-gradient(180deg,var(--color-amber-400),var(--color-amber-500))] text-amber-950 shadow-[0_0_0_1px_var(--color-amber-600),0_2px_4px_color-mix(in_srgb,var(--color-amber-500)_30%,transparent)] inset-shadow-[0_1px_0_rgb(255_255_255/0.45),0_-1px_0_rgb(0_0_0/0.1)] hover:bg-[linear-gradient(90deg,var(--color-amber-400),var(--color-amber-500))] hover:shadow-[0_0_0_1px_var(--color-amber-700),0_2px_4px_color-mix(in_srgb,var(--color-amber-500)_42%,transparent)] hover:inset-shadow-[0_1px_0_rgb(255_255_255/0.55),0_-1px_0_rgb(0_0_0/0.12)] data-pressed:brightness-95 disabled:shadow-none disabled:inset-shadow-none dark:bg-[linear-gradient(180deg,var(--color-amber-400),color-mix(in_srgb,var(--color-amber-500)_78%,black))] dark:shadow-[0_0_0_1px_rgb(0_0_0/0.5),0_2px_6px_rgb(0_0_0/0.35)] dark:inset-shadow-[0_1px_0_rgb(255_255_255/0.32),0_-1px_0_rgb(0_0_0/0.22)] dark:hover:bg-[linear-gradient(90deg,var(--color-amber-400),var(--color-amber-500))] dark:hover:shadow-[0_0_0_1px_rgb(0_0_0/0.65),0_2px_6px_color-mix(in_srgb,var(--color-amber-500)_38%,transparent)] dark:hover:inset-shadow-[0_1px_0_rgb(255_255_255/0.42),0_-1px_0_rgb(0_0_0/0.24)] *:data-[slot=button-loading-indicator]:text-amber-950",
    },
  },
});
